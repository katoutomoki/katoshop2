...
<body>
	...
	<form action="remake-message" method="POST">
		<table class="table-list">
			<tr>
				<th>送り主</th><th>内容</th><th>日時</th><th>確認</th><th>削除</th>
			</tr>
	...
	<%
			...
			for (int idx = 0; idx < ml.size(); idx++) {
				...
				if(name.equals(mess.getRecipientName())){
	%>
	
			<tr>
				<td class="tableSize15"><%=mess.getSenderName() %></td>
				...
				<td class="tableSize10">
					<input type="checkbox" name="read" value="<%=mess.getNumber() %>"
						<% if(mess.getReadNumber().equals("1")){ %> checked <% } %>>
				</td>
				<td class="tableSize10">
	...
	%>
		...
		<input type="hidden" name="jsp" value="messageRecieveLog.jsp">
